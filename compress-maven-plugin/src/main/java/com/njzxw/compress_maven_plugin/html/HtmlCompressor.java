...
public class HtmlCompressor {
	...
	public static void main(String[] args) {
		String spath = "C:\\Users\\eliay\\Desktop\\java\\extract.jsp";
		BufferedReader br = null;
		InputStreamReader fr = null;

		try {
			fr = new InputStreamReader(new FileInputStream(spath), "utf-8");
			...
			String result = HtmlCompressor.compress(str.toString());
